...
public class RemoveWhileLooping {
    public static void main(String[] args) {
        ...
        // traditional loop w/ removing doesn't work because indexes/elements get shifted so it could skip some elements
...
//        }
        ...
        // removing in a foreach loop is also invalid because we cannot change the size of the arraylist/ collection when looping in the foreach loop
//        for (int each : list) {
//            if (each < 5){
//                list.remove(each);
//            }
