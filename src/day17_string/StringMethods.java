...
public class StringMethods {
    public static void main(String[] args) {
        ...
        System.out.println(name.equals("James"));
        System.out.println(name.equalsIgnoreCase("James")); // this method allows ignoring case sensitivity

        String a = new String("hello");
        String b = new String("hello");
        System.out.println(a.equals(b)); // compares a object with the b object
