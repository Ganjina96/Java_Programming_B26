...
Input: {"ted", "talk", "learn"} Output: {"det", "klat", "nrael"}
    ...
    public static ArrayList<String> reverseAll(ArrayList<String> list){
        ...
        for (String each : list){
            ...
            // we call the reverse method in the StringUtil class to reverse each word, each element then we are adding the reversed word into the "reversedWords" arraylist
        }
        return reverseWords;
    }
