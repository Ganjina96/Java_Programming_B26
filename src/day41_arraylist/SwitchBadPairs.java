...
public class SwitchBadPairs {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<String> words = new ArrayList<>(Arrays.asList("Cat", "in", "the", "bag"));

        for (int i = 0; i < words.size(); i += 2) {

            String temp = words.get(i); // "Cat" is currently here in order to not lose the value when we swap for the first time Cat and in
