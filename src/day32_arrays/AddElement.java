...
public class AddElement {
     ...
     */
        ...
        for (int i = 0; i < nums.length; i++) { // purpose of this loop is to get all the numbers for the array
        ...
        System.out.println("Array after addition of another element: "  + Arrays.toString(expanded));
