...
public class Wild {
    public static void main(String[] args) {
        ...
        //reptile.skinColor = "camo"; // Reptile reference does not have access to skinColor varibale
...
//all Lizard objects but with different references
// object does the execution, not reference
